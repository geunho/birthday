      ...
      <div class="timeline">
        <div class="panel panel-default right">
          ...
          <div class="panel-body">
            <p><b>3.0kg</b>의 작은 아기로 태어난 감귤이 🍊</p>
          </div>
        </div>
        ...
        <div class="panel panel-default right">
          ...
          <div class="panel-body">
            <p>엄마가 떠준 🧶 다홍빛 상하의를 입고. (도치는 궁금해 🐕)</p>
          </div>
        </div>
        <div class="panel panel-default left">
          <div class="panel-heading">
        ...
        <div class="panel panel-default left">
          ...
          <div class="panel-body">
            <p>엄빠가 처음 사준 배넷수트 입고 50일 기념 찰칵</p>
          </div>
        </div>
